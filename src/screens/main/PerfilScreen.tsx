...
const styles = StyleSheet.create({
    ...
    adminName: { color: 'white', fontSize: 22, fontWeight: 'bold' },
    adminEmail: { color: '#A0A0B0', fontSize: 14, marginTop: 4 },
    ...
    sectionTitle: { color: '#A0A0B0', fontSize: 12, fontWeight: 'bold', textTransform: 'uppercase', letterSpacing: 1.5, marginBottom: 15, marginTop: 10 },
    card: { backgroundColor: '#1E1E3A', borderRadius: 16, padding: 16, marginBottom: 25, borderWidth: 1, borderColor: '#2A2A4A' },
    label: { color: '#606080', fontSize: 12, fontWeight: '600', marginBottom: 8, marginLeft: 2 },
    input: { backgroundColor: '#2A2A4A', borderRadius: 12, borderWidth: 1, borderColor: '#3A3A5A', color: 'white', padding: 14, fontSize: 15, height: 50 },
    inputDisabled: { flexDirection: 'row', alignItems: 'center', opacity: 0.7 },
    infoText: { color: '#606080', fontSize: 11, marginTop: 8, fontStyle: 'italic' },
    ...
    tzItem: { paddingHorizontal: 10, paddingVertical: 6, borderRadius: 8, backgroundColor: '#2A2A4A', marginRight: 8, marginBottom: 8, borderWidth: 1, borderColor: '#3A3A5A' },
    tzItemActive: { backgroundColor: '#E94560', borderColor: '#E94560' },
    tzText: { color: '#A0A0B0', fontSize: 12 },
    ...
    menuItemText: { color: 'white', fontSize: 15, marginLeft: 15 },
    divider: { height: 1, backgroundColor: '#2A2A4A', marginVertical: 4 },
    ...
    versionText: { color: '#3A3A5A', fontSize: 11, textAlign: 'center', marginTop: 30 },
    modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.8)', justifyContent: 'center', padding: 20 },
    modalContent: { backgroundColor: '#1E1E3A', borderRadius: 20, padding: 25, borderWidth: 1, borderColor: '#2A2A4A' },
