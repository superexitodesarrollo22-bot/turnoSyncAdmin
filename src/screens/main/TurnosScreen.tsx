...
const styles = StyleSheet.create({
    ...
    headerTitle: { color: '#1A1A1A', fontSize: 28, fontWeight: 'bold' },
    ...
    viewSwitcher: { flexDirection: 'row', backgroundColor: '#EDEDEA', borderRadius: 10, padding: 4 },
    ...
    dateBtnText: { color: '#1A1A1A', fontSize: 16, fontWeight: '600' },
    filterScroll: { paddingLeft: 20, marginBottom: 15, maxHeight: 40 },
    filterChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, borderWidth: 1, borderColor: '#DEDEDB', marginRight: 10, height: 36, justifyContent: 'center' },
    filterChipActive: { backgroundColor: '#E94560', borderColor: '#E94560' },
    filterChipText: { color: '#5A5A5A', fontSize: 13, fontWeight: '500' },
    ...
    summaryText: { color: '#9A9A9A', fontSize: 11 },
    funnelBtn: { padding: 4 },
    filterBadge: { position: 'absolute', top: 0, right: 0, width: 8, height: 8, borderRadius: 4, backgroundColor: '#4A9FFF', borderWidth: 1, borderColor: '#FFFFFF' },
    content: { flex: 1 },
    listContent: { paddingHorizontal: 14, paddingTop: 6, paddingBottom: 100, gap: 6 },
    appointmentCard: { flexDirection: 'row', backgroundColor: '#FFFFFF', borderRadius: 12, overflow: 'hidden', borderWidth: 1, borderColor: '#DEDEDB' },
    statusBand: { width: 5 },
    cardContent: { flex: 1, paddingHorizontal: 10, paddingVertical: 8 },
    timeBlock: { width: 62, marginRight: 8 },
    timeText: { color: '#1A1A1A', fontSize: 13, fontWeight: 'bold' },
    durationText: { color: '#9A9A9A', fontSize: 11 },
    clientBlock: { flex: 1, paddingRight: 6 },
    clientName: { color: '#1A1A1A', fontSize: 14, fontWeight: '700' },
    clientContact: { color: '#5A5A5A', fontSize: 11 },
    serviceNameText: { color: '#5A5A5A', fontSize: 11, marginLeft: 4, flex: 1 },
    ...
    notesBox: { marginTop: 5, paddingVertical: 4, paddingHorizontal: 8, backgroundColor: '#EDEDEA', borderRadius: 6, borderLeftWidth: 2, borderLeftColor: '#4A9FFF' },
    notesText: { color: '#5A5A5A', fontSize: 11, fontStyle: 'italic' },
    ...
    weekDayBtn: { width: (width - 60) / 7, height: 65, justifyContent: 'center', alignItems: 'center', borderRadius: 12, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: '#DEDEDB' },
    weekDayBtnActive: { backgroundColor: '#E94560', borderColor: '#E94560' },
    weekDayLabel: { color: '#5A5A5A', fontSize: 12, marginBottom: 4 },
    weekDayLabelActive: { color: 'white', fontWeight: 'bold' },
    weekDayNum: { color: '#1A1A1A', fontSize: 16, fontWeight: 'bold' },
    ...
    timelineTime: { width: 60, paddingVertical: 10, borderRightWidth: 1, borderRightColor: '#DEDEDB' },
    timelineTimeText: { color: '#9A9A9A', fontSize: 12, fontWeight: 'bold' },
    ...
    timelineAppName: { color: '#1A1A1A', fontSize: 13, fontWeight: 'bold' },
    timelineAppService: { color: '#1A1A1A', fontSize: 11, opacity: 0.8 },
    timelineEmpty: { flex: 1, justifyContent: 'center', borderStyle: 'dashed', borderWidth: 1, borderColor: '#DEDEDB', borderRadius: 8, paddingLeft: 10 },
    timelineEmptyText: { color: '#BCBCBC', fontSize: 12 },
    modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
    bottomSheet: { backgroundColor: '#FFFFFF', borderTopLeftRadius: 30, borderTopRightRadius: 30, padding: 24, maxHeight: height * 0.9 },
    sheetHandle: { width: 40, height: 5, backgroundColor: '#DEDEDB', borderRadius: 5, alignSelf: 'center', marginBottom: 20 },
    sheetHeader: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 25 },
    sheetSection: { marginBottom: 25 },
    sheetSectionTitle: { color: '#5A5A5A', fontSize: 12, fontWeight: 'bold', letterSpacing: 1, marginBottom: 15, textTransform: 'uppercase' },
    detailRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 15 },
    detailValue: { color: '#1A1A1A', fontSize: 16, fontWeight: 'bold' },
    detailSubValue: { color: '#5A5A5A', fontSize: 13, marginTop: 2 },
    clientInfoCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#EDEDEA', padding: 16, borderRadius: 16 },
    ...
    copyBtn: { padding: 10 },
    notesContainer: { backgroundColor: '#EDEDEA', padding: 16, borderRadius: 16 },
    notesTextContent: { color: '#5A5A5A', fontSize: 14, fontStyle: 'italic', lineHeight: 20 },
    actionsContainer: { paddingTop: 20, borderTopWidth: 1, borderTopColor: '#DEDEDB' },
    ...
    staffNameSmall: { color: '#9A9A9A', fontSize: 11, marginLeft: 3, maxWidth: 80 },
    cardRow: { flexDirection: 'row', alignItems: 'center', marginBottom: 4 },
    cardRow2: { flexDirection: 'row', alignItems: 'center', flexWrap: 'nowrap' },
    staffAssignCard: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#EDEDEA', padding: 16, borderRadius: 16 },
    ...
    dialogBox: { backgroundColor: '#FFFFFF', borderRadius: 24, padding: 24, width: '85%', alignSelf: 'center', borderWidth: 1, borderColor: '#DEDEDB' },
    dialogTitle: { color: '#1A1A1A', fontSize: 20, fontWeight: 'bold', marginBottom: 5, textAlign: 'center' },
    dialogSubtitle: { color: '#5A5A5A', fontSize: 14, marginBottom: 20, textAlign: 'center' },
    staffOption: { flexDirection: 'row', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#DEDEDB' },
    ...
    staffOptionName: { color: '#1A1A1A', fontSize: 15, fontWeight: 'bold' },
    staffOptionSpecialty: { color: '#9A9A9A', fontSize: 12 },
