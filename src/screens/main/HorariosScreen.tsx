...
const styles = StyleSheet.create({
    ...
    headerHeaderTitle: { color: '#1A1A1A', fontSize: 24, fontWeight: 'bold' },
    scroll: { padding: 20, paddingBottom: 100 },
    section: { marginBottom: 32 },
    sectionTitle: { color: '#1A1A1A', fontSize: 18, fontWeight: 'bold', marginBottom: 4 },
    sectionSubtitle: { color: '#5A5A5A', fontSize: 13, marginBottom: 16 },
    card: { backgroundColor: '#FFFFFF', borderRadius: 16, padding: 16, borderWidth: 1, borderColor: '#DEDEDB' },
    scheduleRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingVertical: 12, borderBottomWidth: 1, borderBottomColor: '#EDEDEA' },
    dayInfo: { flexDirection: 'row', alignItems: 'center' },
    dayName: { color: '#1A1A1A', fontSize: 15, fontWeight: '600', marginLeft: 12 },
    disabledText: { color: '#9A9A9A' },
    timeInfo: { flexDirection: 'row', alignItems: 'center' },
    timeRangeText: { color: '#5A5A5A', fontSize: 14 },
    closedText: { color: '#9A9A9A', fontSize: 14, fontStyle: 'italic' },
    ...
    infoCard: { flexDirection: 'row', backgroundColor: 'rgba(74, 159, 255, 0.05)', padding: 12, borderRadius: 12, marginBottom: 16 },
    infoCardText: { color: '#5A5A5A', fontSize: 12, flex: 1, marginLeft: 8, lineHeight: 18 },
    intervalGrid: { flexDirection: 'row', flexWrap: 'wrap', marginHorizontal: -5 },
    intervalBtn: { width: (width - 50) / 3, height: 44, backgroundColor: '#FFFFFF', borderRadius: 12, justifyContent: 'center', alignItems: 'center', margin: 5, borderWidth: 1, borderColor: '#DEDEDB' },
    intervalBtnActive: { backgroundColor: '#E94560', borderColor: '#E94560' },
    intervalBtnText: { color: '#5A5A5A', fontSize: 13, fontWeight: 'bold' },
    intervalBtnTextActive: { color: 'white' },
    intervalHint: { color: '#9A9A9A', fontSize: 12, marginTop: 12, textAlign: 'center', fontStyle: 'italic' },
    ...
    emptyContainer: { alignItems: 'center', paddingVertical: 40, backgroundColor: '#FFFFFF', borderRadius: 16, borderStyle: 'dashed', borderWidth: 1, borderColor: '#DEDEDB' },
    emptyText: { color: '#9A9A9A', marginTop: 10 },
    blackoutItem: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', backgroundColor: '#FFFFFF', padding: 16, borderRadius: 16, marginBottom: 10, borderWidth: 1, borderColor: '#DEDEDB' },
    blackoutInfo: { flex: 1 },
    blackoutDate: { color: '#1A1A1A', fontSize: 15, fontWeight: 'bold' },
    blackoutReason: { color: '#5A5A5A', fontSize: 13, marginTop: 2 },
    // Modal Styles
    modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'center', padding: 20 },
    modalContent: { backgroundColor: '#FFFFFF', borderRadius: 24, padding: 24, borderWidth: 1, borderColor: '#DEDEDB' },
    modalTitle: {
        color: '#1A1A1A',
        fontSize: 20,
        fontWeight: 'bold',
    ...
    timeLabel: { color: '#5A5A5A', fontSize: 12, textAlign: 'center', marginBottom: 10, fontWeight: 'bold' },
    timeList: {
        height: 220,
    ...
    timeOptionText: { color: '#5A5A5A', fontSize: 16 },
    ...
    cancelText: { color: '#5A5A5A', fontSize: 15, fontWeight: '600' },
    ...
    label: { color: '#1A1A1A', fontSize: 14, fontWeight: 'bold', marginBottom: 10 },
    inputGroup: { marginTop: 20 },
    input: { backgroundColor: '#F5F5F0', borderRadius: 12, paddingHorizontal: 16, height: 50, color: '#1A1A1A', borderWidth: 1, borderColor: '#DEDEDB' },
    // Confirm modal
    confirmModalContent: {
